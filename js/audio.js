window.onload=function(){
	...
	var tou=["images/hou_0.jpg","images/hou_1.jpg","images/hou_2.jpg"];
	...
	function fPlayMusic(){
		...
		if(audio.paused){
			audio.play();
			oPlayOrPause.style.backgroundImage="url(images/img1/stop.png)";
			photo.className="rotate";
		}else{
			audio.pause();
			oPlayOrPause.style.backgroundImage="url(images/img1/start.png)";
			photo.className="";
		}
	}
